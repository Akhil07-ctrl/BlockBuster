          ...
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <SignedOut>
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
              >
                <Link to="/sign-in" className="relative group px-5 py-2 bg-gradient-to-r from-brand-500 to-brand-600 text-white rounded-lg text-sm font-bold overflow-hidden shadow-lg shadow-brand-500/20">
